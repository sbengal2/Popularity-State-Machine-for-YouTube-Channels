...
/**
 * UltraPopular state performs the operations in a channel and switches to other states when needed.
 * popularity score range for the state - 100000 < popularity score <= INT_MAX.
 *
 * @author Shashank Bengaluru Srinivasa .
 */
public class UltraPopular extends AbstractState  {
    private String output;
    private static final StateName stateName = StateName.ULTRA_POPULAR;
     ...
     */
    public UltraPopular(FileDisplayInterface fileDisplayInterfaceIn, StdoutDisplayInterface stdoutDisplayInterfaceIn,ContextI contextIn) {
    ...
    public String toString(){
        return "implements Ultra_popular state of the channel";
    }
