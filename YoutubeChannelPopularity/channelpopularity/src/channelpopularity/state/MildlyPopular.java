...
/**
 * MildlyPopular state performs the operations in a channel and switches to other states when needed.
 * popularity score range for the state - 1000 < popularity score <= 10000.
 *
...
public class MildlyPopular extends AbstractState{
    ...
    private static final StateName stateName = StateName.MILDLY_POPULAR;
     ...
     */
    public MildlyPopular(FileDisplayInterface fileDisplayInterfaceIn, StdoutDisplayInterface stdoutDisplayInterfaceIn,ContextI contextIn){
    ...
    public String toString(){
        return "implements Mildly_popular state of the channel";
    }
