...
/**
 * HighlyPopular state performs the operations in a channel and switches to other states when needed.
 * popularity score range for the state - 10000 < popularity score <= 100000
 *
...
public class HighlyPopular extends AbstractState{
    ...
    private static final StateName stateName = StateName.HIGHLY_POPULAR;
     ...
     */
    public HighlyPopular(FileDisplayInterface fileDisplayInterfaceIn, StdoutDisplayInterface stdoutDisplayInterfaceIn,ContextI contextIn){
        fileDisplayInterface = fileDisplayInterfaceIn;
        stdoutDisplayInterface = stdoutDisplayInterfaceIn;
        contextI = contextIn;
        videoDataBase = contextI.getVideoDataBase();
    ...
    public String toString(){
        return "implements Highly_popular state of the channel";
    }

    /**
     * method that adds video to the channel.
     *
